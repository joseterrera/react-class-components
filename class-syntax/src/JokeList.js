...
class JokeList extends Component {
  ...
  //if you are not binding an event or maintaining state, you probably don't need a constructor.
  constructor(props) {
    //super calls the constructor of the parent class, which in this case would be React.Component
    super(props)
    this.state = {
      //the perfect place to set the initial state of a component is here
      jokes: []
    };
  ...
  async getJokes() {
    try {
      //load jokes one at time, adding not-yet-seen jokes
