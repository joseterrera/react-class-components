...
class Joke extends Component {
  constructor(props) {
    //super refers to the parent class constructor - it is required when you need to access some variables of the parent class, once you use super, then you can use `this`
    super(props);
